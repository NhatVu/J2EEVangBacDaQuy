		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="row text-center">
					<h4 style="margin-bottom: 25px !important;">Phiếu bán hàng</h4>
				</div>
				<hr />
			</section>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<button id="luuPhieu" type="button"
								class="btn btn-primary btn-block">Lưu phiếu bán hàng</button>
						</div>
					</div>
				</div>
			</section>
...
.customer-infor .row {
	...
	<script>
		...
		function luuPhieuBanHang() {
			...
			$.LoadingOverlay("show");
			$.ajax({
				url : 'luuPhieuBanHang?maPhieu=' + o.maPhieu + '&ngayBan='
