		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="row text-center">
					<h4 style="margin-bottom: 25px !important;">Lập phiếu dịch vụ
					</h4>
				</div>
				<hr />
			</section>
				...
				<div class="">
					...
					<div class="box-footer no-border">
						<div class="row col-xs-12">
							<strong>Danh sách chi tiết dịch vụ</strong>
						</div>
						<div class="row">
							<div class="col-xs-12">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<button id="luuPhieu" type="button"
								class="btn btn-primary btn-block">Lưu phiếu dịch vụ</button>
						</div>
					</div>
				</div>
			</section>
	...
	<script>
			...
			$.ajax({
				...
				success : function(data) {
					...
					for (var i = 0; i < list.length; i++) {
						content += "<option  value='"+list[i].maDV+"'>"
								+ list[i].tenDV + "</option>";
					}
		...
		function getProduct(maDV) {
			for (var i = 0; i < danhSachSanPham.length; i++) {
				if (danhSachSanPham[i].maDV == maDV)
		...
		function luuPhieuDichVu() {
			...
			$.LoadingOverlay("show");
			$.ajax({
				url : 'luuPhieuDichVu?maPhieu=' + o.maPhieu + '&ngayBan='
